		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#neoriscursosfioritestproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"neoriscursosfioritestproject1-display": {
								"semanticObject": "neoriscursosfioritestproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=neoris.cursos.fiori.test.project1",
									"url": sap.ui.require.toUrl("neoris/cursos/fiori/test/project1")
								}
							}
						}
					}
